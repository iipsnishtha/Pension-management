	...
	<div class="container mt-4">
		...
		<div class="card text-white align-items-center text-center">
			...
			<div class="card-body">
				...
				<h4>${processPensionFailureMessage}</h4>

				<a class="tryagain" href="/processPensionForm" class="text-white"><button
						class="btn btn-success mt-4 col-sm-6 btn-lg">Try Again</button></a> <a
					class="tryagain" href="/pensionerDetailForm" class="text-white"><button
						class="btn btn-success mt-4 col-sm-6 btn-lg">Calculate
						Again</button></a>
			</div>
		</div>
	</div>
